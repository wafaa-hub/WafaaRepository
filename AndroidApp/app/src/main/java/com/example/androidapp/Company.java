...
public class Company {
    ...
    public   String   getGclose() { return gclose; }

    public   String   getChange() { return change; }

    public   String   getGvolume() { return gvolume; }

    public   String   getGesi() { return gesi; }
    ...
    public void updateCompany(JSONObject jsonObject) throws Exception {
